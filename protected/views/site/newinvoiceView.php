...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary(array($Users, $Address, $Ourinvoices)); ?>
        ...
        <div class="row">
		<?php echo $form->labelEx($Users,'Adresse', array('class'=>'test')); ?>
		<?php echo $form->textField($Users,'email'); ?>
		<?php echo $form->error($Users,'email'); ?>
	</div>
        <div class="row">
		<?php echo $form->labelEx($Users,'Postnummer', array('class'=>'test')); ?>
		<?php echo $form->textField($Users,'email'); ?>
		<?php echo $form->error($Users,'email'); ?>
	</div>
        <div class="row">
		<?php echo $form->labelEx($Users,'By', array('class'=>'test')); ?>
		<?php echo $form->textField($Users,'email'); ?>
		<?php echo $form->error($Users,'email'); ?>
	</div>
        ...
        <div class="row">
		<?php echo $form->labelEx($Ourinvoices,'Adresse', array('class'=>'test')); ?>
		<?php echo $form->textField($Ourinvoices,'invoicenumber'); ?>
		<?php echo $form->error($Ourinvoices,'invoicenumber'); ?>
	</div>
         <div class="row">
	...
	<?php echo $form->error($Address,'zip'); ?>
        ...
        <div class="row">
        <?php echo $form->labelEx($Address,'Faktura dato', array('class'=>'test')); ?>
        <?php echo $form->textField($Address,'zip'); ?>
	<?php echo $form->error($Address,'zip'); ?>
        </div>
        <div class="row">

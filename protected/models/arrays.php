...
array(4) { 
    ["User"]=> array(4) { 
        ["username"]=> string(6) 
        "asdasd" ["firstname"]=> string(6) 
        "asdasd" ["lastname"]=> string(6) 
        "asdasd" ["email"]=> string(18) 
        "fffffff@ffffff.com" 
        } 
        ["Address"]=> array(6) { 
        ["phone"]=> string(6)"141341" 
        ["address1"]=> string(6)"asdasd" 
        ["address2"]=> string(6)"asdasd" 
        ["address3"]=> string(3)"qwe" 
        ["zip"]=> string(4)"4444" 
        ["city"]=> string(5) "bbbbb" 
        ...
        ["email"]=> string(14) "asdasd@gma.com" 
        } ["yt0"]=> string(6) "Submit" };
*/
/* Det nye array */ 
/*
array(4) { 
    ...
    ["email"]=> string(16) "qweqwe@gmail.com" 
      
    } 
    ["Address"]=> array(2) { 
    [1]=> array(6) { 
    ["phone"]=> string(6) "123123" 
    ["address1"]=> string(6) "zxvzxv" 
    ["address2"]=> string(6) "zxvzxv" 
    ["address3"]=> string(14) "qzxvzxvzvweqwe" 
    ["zip"]=> string(4) "1111" 
    ["city"]=> string(5) "aaaa1" } 
    [2]=> array(5) { 
    ["address1"]=> string(6) "qweqwe" 
    ...
    ["Partner"]=> array(2) { 
    [1]=> array(2) { 
    ["validcvr"]=> string(6) "123123" 
    ["name"]=> string(9) "aaaaaaaa1"
    } 
    [2]=> array(3) { 
    ["name"]=> string(9) "bbbbbbbb2" 
    ["email"]=> string(12) "bbbb@222.com" 
    ["validcvr"]=> string(7) "9898979" } 
    } ["yt0"]=> string(6) "Submit" }
*/
/*
